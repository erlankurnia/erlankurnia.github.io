...
import { RecursivePartial, PowerGlitchOptions } from 'powerglitch';
/**
 ...
 * ```
 */
export declare const vGlitch: Directive<HTMLElement, RecursivePartial<PowerGlitchOptions> | undefined>;
