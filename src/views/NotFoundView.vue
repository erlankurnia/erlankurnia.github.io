			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
				...
				<g id="freepik--Planets--inject-63">
					<g style="opacity: 0.30000000000000004">
						<path d="M201,145.62a1.87,1.87,0,1,1-1.86-1.87A1.86,1.86,0,0,1,201,145.62Z" style="fill: #79678f"></path>
						<circle cx="72.97" cy="216.13" r="1.32" style="fill: #79678f"></circle>
						<circle cx="291.05" cy="408.33" r="1.89" style="fill: #79678f"></circle>
						<circle cx="336.5" cy="332" r="1.32" style="fill: #79678f"></circle>
						<path d="M424.17,95.62a1.32,1.32,0,1,1-1.32-1.32A1.32,1.32,0,0,1,424.17,95.62Z" style="fill: #79678f"></path>
						<path d="M172.75,69a1.32,1.32,0,1,1-1.32-1.32A1.33,1.33,0,0,1,172.75,69Z" style="fill: #79678f"></path>
						<circle cx="277.7" cy="136.94" r="1.32" style="fill: #79678f"></circle>
					</g>
					<circle cx="141.23" cy="116.36" r="21.91" style="fill: #79678f"></circle>
					...
					<path
						...
						style="fill: #79678f; opacity: 0.2"
					></path>
					<path d="M131.5,105.62a2,2,0,1,1-2-2A2,2,0,0,1,131.5,105.62Z" style="fill: #79678f; opacity: 0.2"></path>
					<path d="M155.06,103.62a2,2,0,1,1-2-2A2,2,0,0,1,155.06,103.62Z" style="fill: #79678f; opacity: 0.2"></path>
					<path
				...
				<g id="freepik--Astronaut--inject-63">
					...
					<path
						...
						style="fill: #79678f; opacity: 0.30000000000000004"
					></path>
					<path
					...
					<path
						...
						style="fill: #79678f; opacity: 0.6000000000000001"
					></path>
					<path
				...
				<g id="freepik--Rocket--inject-63">
					...
					<circle cx="222.2" cy="282.18" r="8.29" style="fill: #79678f"></circle>
					<polygon
