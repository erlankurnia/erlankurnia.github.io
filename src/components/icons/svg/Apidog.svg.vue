<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 256 256">
        <defs>
            <linearGradient id="SVGMlE3idTY" x1="0%" x2="99.996%" y1="36.301%" y2="64.611%">
                <stop offset="0%" stop-color="#3BF" />
                <stop offset="100%" stop-color="#73F" />
            </linearGradient>
            <linearGradient id="SVGAEdjLeXL" x1="102.837%" x2="-5.655%" y1="70.777%" y2="28.962%">
                <stop offset="0%" stop-color="#99C2FF" />
                <stop offset="100%" stop-color="#FFF" />
            </linearGradient>
            <linearGradient id="SVG3qFNycnF" x1="49.941%" x2="23.669%" y1="69.215%" y2="32.86%">
                <stop offset="0%" stop-color="#99C2FF" />
                <stop offset="100%" stop-color="#FFF" />
            </linearGradient>
        </defs>
        <path fill="url(#SVGMlE3idTY)"
