<template>
	<section id="about" class="pt-24 pb-16 lg:pb-0">
		<div class="container">
			<div class="flex flex-wrap">
				...
				<div class="w-full px-4 py-0 mb-0 lg:w-1/2">
					<div class="relative mt-10 lg:mt-9 lg:right-0">
						<img src="/img/fotor.comimagescreate_3.png" alt="Generated by https://www.fotor.com" class="w-full mx-auto" />
					</div>
				</div>
				<div class="w-full px-4 lg:w-1/2 mt-12">
					<h3 class="max-w-xl mb-5 text-3xl font-bold text-dark lg:text-4xl">Erlan<span class="text-primary">_</span>Kurnia</h3>
					<table class="table-auto mb-6 w-full text-sm font-medium text-secondary sm:text-base border-separate">
						<thead>
							<tr>
								<th></th>
								<th></th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="w-4"></td>
								<td><a href="mailto://erlank2789@gmail.com">erlank2789@gmail.com</a></td>
							</tr>
						</tbody>
					</table>
