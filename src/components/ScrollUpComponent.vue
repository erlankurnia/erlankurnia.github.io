<template>
	<button id="scroll-up" @click="scrollToPrevSection"
		class="fixed h-12 w-12 z-[9999] right-4 bottom-[46%] hidden -translate-y-12 rounded-full shadow-lg border-[1px] p-1 hover:animate-pulse justify-center items-center lan-glass-effect">
