<template>
	<button id="scroll-up" @click="scrollToPrevSection" title="Scroll to Top" type="button"
		:class="['fixed h-12 w-12 z-[8888] right-4 bottom-[46%] hidden -translate-y-12 rounded-full shadow-lg border-[1px] p-1 hover:animate-pulse justify-center items-center lan-glass-effect 4xl:right-1/2 4xl:-mr-[760px]', $attrs.class]">
