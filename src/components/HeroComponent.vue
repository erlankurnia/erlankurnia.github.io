	...
	<section class="pt-24 -z-10">
		<div class="container">
			<div class="flex flex-wrap h-auto lg:flex-row-reverse">
				<!-- Right / Top side -->
				<div
					class="flex flex-col self-center w-full px-4 h-56 md:h-64 lg:justify-center lg:w-1/2 lg:text-right lg:h-[420px] 2xl:h-[480px] 3xl:h-[660px]">
				...
				<div
					...
					<div class="relative h-full mt-10 md:mt-0 md:flex md:flex-col md:justify-end lg:right-0">
						...
						<img :src="dataUser.image" alt="Erlan Kurnia | Generated by https://www.fotor.com"
							class="z-50 w-full aspect-square mx-auto" />
					</div>
				</div>
				<!-- Left / Bottom side -->
			</div>
