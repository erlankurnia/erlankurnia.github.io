	...
	<section class="pt-24 -z-10">
		<div class="container">
			<div class="flex flex-wrap h-auto lg:flex-row-reverse">
				<!-- Right / Top side -->
				<div
					class="flex flex-col self-center w-full px-4 md:h-64 lg:justify-center lg:w-1/2 lg:text-right lg:h-[420px] 2xl:h-[480px] 3xl:h-[660px]">
