		...
		<div class="container h-full">
			<div class="flex flex-wrap h-full lg:flex-row-reverse">
				...
				<div
					...
					<p class="mb-10 text-sm font-medium leading-relaxed sm:text-base text-secondary"
					...
					<div
						...
						<span id="splash-liquid"
							...
							<!-- <svg width="100%" height="100%" class="fill-current slime" viewBox="0 0 200 200"
								xmlns="http://www.w3.org/2000/svg">
								<path
									d="M42.3,-73.8C51.4,-68,52.9,-49.7,56,-35.3C59.1,-21,63.7,-10.5,63.4,-0.2C63.1,10.1,57.8,20.2,53.3,32.1C48.8,44.1,45.1,57.8,36.3,63C27.6,68.1,13.8,64.6,-1.4,67.1C-16.6,69.6,-33.3,78,-42.1,72.9C-51,67.8,-52,49.2,-57.2,34.8C-62.3,20.4,-71.5,10.2,-77,-3.2C-82.5,-16.5,-84.2,-33.1,-78.7,-46.8C-73.2,-60.6,-60.4,-71.5,-46.1,-74.3C-31.7,-77.1,-15.9,-71.7,0.4,-72.3C16.6,-73,33.2,-79.7,42.3,-73.8Z"
...
export default {
	...
	setup() {
		...
		return { text, letters, texts, isPageLoaded, dataUser };
	},
};
</script>
