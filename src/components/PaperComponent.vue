<template>
	<div class="flex justify-end w-screen h-screen text-white bg-black perspective">
		<div
			class="absolute flex items-end w-1/2 h-screen transition duration-1000 origin-left transform page"
			data-page="2"
...
export default {
	...
	methods: {
		togglePageFlip(event) {
			this.setAllPagesBack();
			this.setClickedPageForward(event);
		...
		setClickedPageForward(event) {
			event.target.classList.add("z-50");
		},
	},
};
</script>
